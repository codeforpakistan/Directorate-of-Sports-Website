		...
		public function add_style_manager_options() {
			...
			$this->controls_manager->add_responsive_control(
				[
					...
					'units'        => jet_woo_product_gallery_tools()->get_slider_nav_controls_position_ranges( 'blocks' ),
					'css_selector' => [
						$this->css_selector( '.jet-woo-swiper-vertical ' . $this->css_scheme['pagination'] ) => 'right: {{VALUE}}{{UNIT}}; left: auto;',
					],
					'condition'    => [
			...
			$this->controls_manager->add_responsive_control(
				[
					...
					'units'        => jet_woo_product_gallery_tools()->get_slider_nav_controls_position_ranges( 'blocks' ),
					'css_selector' => [
						$this->css_selector( '.jet-woo-swiper-vertical ' . $this->css_scheme['pagination'] ) => 'left: {{VALUE}}{{UNIT}}; right: auto;',
					],
					'condition'    => [
			...
			$this->controls_manager->add_responsive_control(
				[
					...
					'separator'    => 'before',
					'css_selector' => [
						$this->css_selector( $this->css_scheme['pagination-items'] ) => 'margin: {{TOP}} {{RIGHT}} {{BOTTOM}} {{LEFT}};',
					],
				]
			);
