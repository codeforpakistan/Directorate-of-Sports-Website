		...
		public function add_style_manager_options() {
			...
			$this->controls_manager->add_responsive_control(
				[
					...
					'units'        => [ 'px', '%' ],
					'css_selector' => [
						$this->css_selector( $this->css_scheme['image-2'] ) => 'margin: {{TOP}} 0 {{BOTTOM}} 0;',
					],
				]
			);
			...
			$this->controls_manager->add_responsive_control(
				[
					...
					'units'        => [ 'px', '%' ],
					'css_selector' => [
						$this->css_selector( $this->css_scheme['image-3'] ) => 'margin: {{TOP}} 0 {{BOTTOM}} 0;',
					],
				]
			);
			...
			$this->controls_manager->add_responsive_control(
				[
					...
					'units'        => [ 'px', '%' ],
					'css_selector' => [
						$this->css_selector( $this->css_scheme['image-4'] ) => 'margin: {{TOP}} 0 {{BOTTOM}} 0;',
					],
				]
			);
			...
			$this->controls_manager->add_responsive_control(
				[
					...
					'units'        => [ 'px', '%' ],
					'css_selector' => [
						$this->css_selector( $this->css_scheme['image-5'] ) => 'margin: {{TOP}} 0 {{BOTTOM}} 0;',
					],
				]
			);
