...
class Form {
	...
	public function calendar_assets() {
		...
		ob_start();
			include_once JET_APB_PATH . 'assets/css/public/jet-appointments-booking.css';
			include_once JET_APB_PATH . 'assets/css/public/flatpickr.min.css';
			include_once JET_APB_PATH . 'assets/css/public/vanilla-calendar.css';
		$init_style = ob_get_clean();
		$style_handle = 'jet-appointments-booking';
		...
		wp_enqueue_script(
				'flatpickr-4.6.9',
				JET_APB_URL . 'assets/js/public/flatpickr.js',
		...
		wp_add_inline_style( $style_handle, $init_style );
		...
		if ( wp_doing_ajax() ) {
			...
			$moment           = add_query_arg(
				array( 'ver' => JET_APB_VERSION ),
				JET_APB_URL . 'assets/js/admin/lib/moment.min.js'
			);
